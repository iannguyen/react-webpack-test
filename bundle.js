...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (root) {
	  ...
	  var routes = React.createElement(
	    Route,
	    { path: '/', component: Home },
	    React.createElement(Route, { path: 'test', component: Another })
	  );
...
/***/ function(module, exports, __webpack_require__) {
	...
	Router = __webpack_require__(160).Router;
	Route = __webpack_require__(160).Route;
	IndexRoute = __webpack_require__(160).IndexRoute;
	Link = __webpack_require__(160).Link;
	
	req = __webpack_require__(218);
